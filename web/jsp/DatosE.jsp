<%-- 
    Document   : DatosE
    Created on : 19/10/2019, 03:32:20 PM
    Author     : miche
--%>
                ...
                <center>
                    <nav>
                        <ul> <center>
                                ...
                                <li><a href="contmodificar.do"><font  size="20" face ="Indie Flower">MODIFICAR</font></a></li>
                                <li><a href="conteliminar.do"><font  size="20" face ="Indie Flower">ELIMINAR</font></a></li>
                                <li><a href="contconsultar.do"><font  size="20" face ="Indie Flower">CONSULTAR</font></a></li>
                            </center>                            
                        </ul>
                    </nav>
                </center>
